      ...
      <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div class="sm:col-span-2">
          ...
          <div class="mt-6 lg:max-w-sm">
            <p class="text-sm text-gray-800">
              Connect with like-minded visionaries, share your success, and elevate your network in a world of luxury and opportunity. Your elite circle starts here.
            </p>
            <p class="mt-4 text-sm text-gray-800">
              Build meaningful connections, showcase your achievements, and thrive in a community that celebrates success. Your next big opportunity is just a tap away.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <p class="mt-4 text-sm text-gray-500">
            Head over to our Facebook page to stay connected, discover exclusive updates, and join a community that’s shaping the future of networking. See you there!
          </p>
        </div>
      </div>
      <div class="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p class="text-sm text-gray-600">
          © Copyright 2025 PLUMMY IO. All rights reserved.
        </p>
