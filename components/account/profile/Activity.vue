        ...
        <div class="relative mb-8">
          ...
          <div class="ml-24">
            ...
            <div class="mb-4 border rounded-lg shadow-sm bg-card text-card-foreground">
              ...
              <div class="p-6 pt-0">
                <p class="text-muted-foreground">During discovery, we analyze your requirements, conduct market research, and create a detailed project roadmap. This phase is crucial for setting clear expectations and goals.</p>
              </div>
              <div class="flex items-center p-6 pt-0">
                <p class="text-sm text-muted-foreground">Typical duration: 1-2 weeks</p>
              </div>
            </div>
          </div>
        </div>
        <div class="relative mb-8">
          ...
          <div class="ml-24">
            ...
            <div class="mb-4 border rounded-lg shadow-sm bg-card text-card-foreground">
              ...
              <div class="p-6 pt-0">
                <p class="text-muted-foreground">We follow an agile methodology with 2-week sprints. Each sprint includes planning, development, testing, and review cycles. You'll receive regular updates and demos.</p>
              </div>
              <div class="flex items-center p-6 pt-0">
                <p class="text-sm text-muted-foreground">Typical duration: 8-12 weeks</p>
              </div>
            </div>
          </div>
        </div>
        <div class="relative mb-8">
          ...
          <div class="ml-24">
            ...
            <div class="mb-4 border rounded-lg shadow-sm bg-card text-card-foreground">
              ...
              <div class="p-6 pt-0">
                <p class="text-muted-foreground">We conduct comprehensive testing including unit tests, integration tests, user acceptance testing (UAT), and performance testing to ensure quality.</p>
              </div>
              <div class="flex items-center p-6 pt-0">
                <p class="text-sm text-muted-foreground">Typical duration: 2-3 weeks</p>
              </div>
            </div>
          </div>
        </div>
        <div class="relative mb-8">
          ...
          <div class="ml-24">
            ...
            <div class="mb-4 border rounded-lg shadow-sm bg-card text-card-foreground">
              ...
              <div class="p-6 pt-0">
                <p class="text-muted-foreground">We provide full deployment support, monitoring, and immediate post-launch maintenance. Our team stays on high alert to address any issues that may arise.</p>
              </div>
              <div class="flex items-center p-6 pt-0">
                <p class="text-sm text-muted-foreground">Typical duration: 1 week</p>
              </div>
            </div>
          </div>
        </div>
