<script setup lang="ts">
  ...
  import { usePostLikes, useGetPostLikesCount } from '~/composables/plummy/usePostLikes';
...
<template>
  ...
  <Popover>
    <PopoverTrigger class="flex items-center space-x-2">
      ...
      <small class="text-sm font-semibold leading-none text-muted-foreground" v-if="!isLikesLoading">
        {{ likesCount }}
      </small>
