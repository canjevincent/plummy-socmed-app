<script setup lang="ts">
  ...
  const { mutate: loginUser, isPending: isLoggingIn } = useMutation({
    mutationFn: async (payload: LoginPayload) => {
      return await $fetch('/api/guest/auth/login', {
        method: 'POST',
        body: payload,
      });
    },
    onSuccess: async () => {  
      ...
      // Redirect to account
      await navigateTo('/account/profile/activity');
  ...
  <div class="flex flex-col gap-6">
    <Card class="overflow-hidden">
      <CardContent class="grid p-0 md:grid-cols-2">
        <form class="p-6 md:p-8" @submit.prevent="onSubmit" action="">
          <div class="flex flex-col gap-6">
            ...
            <div class="grid gap-2">
              ...
              <Input
                ...
                :class="{ 
                  'border-red-300 focus:border-red-600': errors.email && submitted && !isLoggingIn,
                  'border-green-300 focus:border-green-600': !errors.email && submitted && !isLoggingIn
                }"
              />
            ...
            <div class="grid gap-2">
              ...
              <Input
                ...
                :disabled="isLoggingIn"
                :class="{ 
                  'border-red-300 focus:border-red-600': errors.password && submitted && !isLoggingIn,
                  'border-green-300 focus:border-green-600': !errors.password && submitted && !isLoggingIn
                }"
              />
            ...
            <Button type="submit" class="w-full" :disabled="isLoggingIn">
              <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" v-if="isLoggingIn" disabled>
            ...
            <div class="grid grid-cols-3 gap-4">
              <Button variant="outline" class="w-full">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" v-if="!isLoggingIn">
                  <path
