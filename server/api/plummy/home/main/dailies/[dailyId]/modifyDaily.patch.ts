  ...
  if(session.user){
    ...
    try {
      ...
      const daily = await prisma.daily.update({
        ...
        data:{
          imageOpacity:imageOpacity.toString(),
          imageBlur:imageBlur.toString(),
          imageBlurFace:imageBlurFace.toString(),
          imageSharpen:imageSharpen.toString(),
          imageBrightness:imageBrightness.toString(),
          imageVibrance:imageVibrance.toString(),
          imageAngle:imageAngle.toString(),
          textContent:textContent.toString(),
          textPositionX:textPositionX.toString(),
          textPositionY:textPositionY.toString(),
          textFontSize:textFontSize.toString(),
          textColor:textColor,
